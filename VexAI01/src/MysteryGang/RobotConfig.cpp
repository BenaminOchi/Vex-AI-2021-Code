...
vex::motor       hwMotorWheelFrontLeft  = vex::motor(PORT11, ratio18_1, true);
vex::motor       hwMotorWheelFrontRight = vex::motor(PORT13, ratio18_1, false);
vex::motor       hwMotorWheelBackLeft   = vex::motor(PORT12, ratio18_1, true);
vex::motor       hwMotorWheelBackRight  = vex::motor(PORT14, ratio18_1, false);
vex::motor       hwMotorIntakeLeft      = vex::motor(PORT5, ratio18_1, false);
vex::motor       hwMotorIntakeRight     = vex::motor(PORT6, ratio18_1, true);
